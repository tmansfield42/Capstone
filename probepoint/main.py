...
def run_pipeline():
    ...
    if not port_scan_ok:
        ...
        try:
            ...
            # Hydra uses its own internal timeout (HYDRA_TIMEOUT_SECONDS, 20 min) — the
            # scan.timeout from settings.yaml is too short for brute-force runs.
            credential_tester.test_all_hosts(output_file, wordlist=wordlist)
